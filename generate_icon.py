#!/usr/bin/env python3
"""Generate Minedew Fishing's mod menu icon: the vanilla fishing rod.
...
OUT = os.path.join(HERE, "src/main/resources/assets/minedew-fishing/icon.png")
...
def build_icon():
    """The mod ships no textures of its own, and its whole subject is the rod,
    so the icon is the vanilla fishing rod at eight times size."""
    return scale(vanilla("item/fishing_rod.png"), 8)
